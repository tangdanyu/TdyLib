...
public class VideoRecordParams {
    ...
    private int pixelFormat = NativeLib.PixelFormat.YUVI420.ordinal();
    ...
    public NativeLib.PixelFormat getPixelFormat() {
        return  NativeLib.PixelFormat.values()[pixelFormat];
    }

    public void setPixelFormat(NativeLib.PixelFormat pixelFormat) {
